        ...
        for nama in name.split(' '):
            if len(name) <= 7:
                if len(nama) < 3:
                    ...
                    self.password.append(nama + '1234567')
                    self.password.append(nama + '12345678')
                    self.password.append(nama + '123123')
                    self.password.append(nama + '100200')
                    self.password.append(nama + '2023')
                    self.password.append(nama + '2022')
                    self.password.append(nama + '2021')
                    self.password.append(nama + '2020')
            else:
                if len(nama) < 3:
